...
namespace AIForGames
{
	...
	Mouse::Mouse(Node* startpos, Node* secondStartpos, Decision* root)
	{
	...
	void Mouse::MouseStateCheck(NodeMap& acsii, Food food, float deltaTime)
	{
		m_decisionRoot->MakeDecision(*this, deltaTime);
	}
